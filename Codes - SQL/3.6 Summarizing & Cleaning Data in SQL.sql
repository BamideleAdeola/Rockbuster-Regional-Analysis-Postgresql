ETL - EXTRACT - DATA FROM MULTIPLE SOURCES, 
TRANSFORM - CONVERT TO ANOTHER FORMAT ( +23450      83435365)
AND 
Load - 
...
GROUP BY col1,
         col2,
         col3, ...
HAVING COUNT(*) > 1 -- REMOVE UNIQUE AND GIVE ME DUPLICATES
...
--Shows only those records that ARE duplicate(based on columns selected)
...
UPDATE FILM 
SET rating = 'G'
WHERE rating = 'gen' OR rating = 'g' OR rating = 'General';
...
SELECT * FROM public.film_cantonese_view;

SELECT * FROM public.film_english_view;
